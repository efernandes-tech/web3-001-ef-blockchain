...
public class TransactionInput
{
    ...
    [JsonConstructor]
    public TransactionInput(string fromAddress, decimal amount, string signature)
    {
    ...
    public TransactionInput(string? fromAddress = null, decimal? amount = null, string? signature = null)
    {
    ...
    public Validation IsValid()
    {
        ...
        try
        {
            ...
            return isValid ? new Validation() : new Validation(false, "Invalid signature.");
        }
        catch
        {
